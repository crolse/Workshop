...
<body>
  <div class="buttonRetour">
    <a href="#"><img src="./Images/Illustrations/SVG/back-arrow-green.svg" /></a>
  </div>
  <div class="titre">
  ...
  <div class="divSection">
    ...
    <div class="divInputSection">
      <input type="text" placeholder="Entrez le titre de votre initiative">
    </div>
    <div class="divTextSection">
      Lieu
    </div>
    ...
    <div class="divInputSection">
      <textarea type="text" placeholder="Ecrivez votre initiative"></textarea>
    </div>
    <div class="divTextSection">
      Sujet
    </div>
